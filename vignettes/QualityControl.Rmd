...
```{r}
ThePlots <- map(.x=XML_Files, .f=LibraryXMLParse, returntype="plots", references=FALSE)
Utility_Patchwork(x=ThePlots, filename="LibraryControls5L", outfolder=NULL, returntype="patchwork", thecolumns=2, therows = 2, width = 7, height = 9)
```
...
```{r}
ThePlots <- map(.x=XML_Files, .f=LibraryXMLParse, returntype="plots", references=TRUE)
Utility_Patchwork(x=ThePlots, filename="LibraryControls5L", outfolder=NULL, returntype="patchwork", thecolumns=2, therows = 2, width = 7, height = 9)
```
...
```{r}
TheData <- map(.x=XML_Files, .f=LibraryXMLParse, returntype="dataframe") %>% bind_rows()
TheData
