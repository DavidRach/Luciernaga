...
walk(.x=KeptMarkers[c(1:10)], .f=Utility_UnityPlot, y="APC-A", GatingSet=gs, sample.name="GROUPNAME", bins=100, clearance=0.2,
                  removestrings=theremovestrings, marginsubset=CD8s, gatesubset=CD8s, gatelines=TRUE, reference=MyGateCutoffs,
                  pdf=TRUE,outpath=OutPath)
