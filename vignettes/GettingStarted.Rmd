...
abstract: |
  Spectral Flow Cytometry (SFC) ability to resolve similar fluorophores is dependent on it's unmixing controls (both single color and unstained). Luciernaga is a series of tools for quality control to profile these controls and their subsequent effects on the unmixing of full-stained samples. 
