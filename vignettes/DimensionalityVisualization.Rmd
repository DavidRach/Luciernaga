...
removestrings <- c("DTR_2023_ILT_15_Tetramers-", "_Tetramer_Unmixed", ".fcs")

tSNE_Output <- Utility_tSNE(x=UnmixedGatingSet[[3]], sample.name = "GROUPNAME", removestrings=removestrings, subset = "live", columns=SubsetMarkers, export=FALSE)
...
Sample_TSNEPlot <-  Utility_ThirdColorPlots(x=NewGatingSet[[1]], subset = "root", xaxis="tSNE_1", yaxis = "tSNE_2",  zaxis ="V7-A", splitpoint = "continuous", sample.name = "GROUPNAME", removestrings = removestrings, thecolor = "orange", tilesize = 0.6)
