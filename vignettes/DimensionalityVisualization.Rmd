...
```{r}
MyCytoSet <- load_cytoset_from_fcs(UnstainedCells, truncate_max_range = FALSE, transform = FALSE)
MyCytoSet
...
```{r}
UnmixedCytoSet <- load_cytoset_from_fcs(Unmixed_FullStained, truncate_max_range = FALSE, transform = FALSE)
...
SingleSample <- Utility_Downsample(UnmixedGatingSet[1], sample.name = "GROUPNAME", removestrings=removestrings, subsets = "live", subsample = 2500, 
                   internal = FALSE, export = FALSE)
SingleSample

# Multiple Samples

MultipleSamples <- map(.x=UnmixedGatingSet, .f=Utility_Downsample, sample.name =  "GROUPNAME", removestrings=removestrings, subsets = "live", 
...
ConcatinatedReturn <- Utility_Concatinate(gs=UnmixedGatingSet, sample.name = "GROUPNAME", removestrings=removestrings, subsets="live", 
                    subsample = 2000, ReturnType = "flow.frame", newName = "MyConcatinatedFile", outpath = StorageLocation, 
                    export = FALSE)
