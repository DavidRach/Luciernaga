...
Utility_SingleColorQC(x=MyGatingSet[2], subsets="lymphocytes", removestrings=removestrings, sample.name="GUID", 
                      ...
                      sourcelocation = NULL, outpath = NULL, artificial = NULL, Brightness = FALSE)
``` 
...
```{r}
UV7 <- Utility_SingleColorQC(x=MyGatingSet[2], subsets="lymphocytes", removestrings=removestrings, sample.name="GUID", 
                      unmixingcontroltype = "cells", Unstained = TRUE, ratiopopcutoff = 0.01, Verbose = FALSE,
                      AFOverlap = AFOverlap, stats = "median", ExportType = "data.frame", SignatureReturnNow = TRUE, 
                      sourcelocation = NULL, outpath = NULL, artificial = NULL, Brightness = FALSE)

V7 <- Utility_SingleColorQC(x=MyGatingSet[2], desiredAF = "V7-A", subsets="lymphocytes", removestrings=removestrings, sample.name="GUID", 
                      unmixingcontroltype = "cells", Unstained = TRUE, ratiopopcutoff = 0.01, Verbose = FALSE,
                      AFOverlap = AFOverlap, stats = "median", ExportType = "data.frame", SignatureReturnNow = TRUE, 
                      sourcelocation = NULL, outpath = NULL, artificial = NULL, Brightness = FALSE)

V3 <- Utility_SingleColorQC(x=MyGatingSet[2], desiredAF = "V3-A", subsets="lymphocytes", removestrings=removestrings, sample.name="GUID", 
                      unmixingcontroltype = "cells", Unstained = TRUE, ratiopopcutoff = 0.01, Verbose = FALSE,
                      AFOverlap = AFOverlap, stats = "median", ExportType = "data.frame", SignatureReturnNow = TRUE, 
                      sourcelocation = NULL, outpath = NULL, artificial = NULL, Brightness = FALSE)
...
```{r}
SC_InternalAF <- Utility_SingleColorQC(x=MyGatingSet[1], subsets="lymphocytes", removestrings=removestrings, sample.name="GUID", 
