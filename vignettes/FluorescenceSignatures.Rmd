...
LuciernagaQC(x=MyGatingSet[2], subsets="lymphocytes", sample.name="GUID", experiment = "Monocytes", 
             ...
             stats = "median", NegativeType = "default",
             ExportType = "fcs", outpath=StorageLocation, Brightness = TRUE, SignatureReturnNow = FALSE)
```
...
```{r}
ThePlots <- LuciernagaReport(data=CombinedData, RetainedType = "normalized", CellPopRatio = 0.05, outfolder = NULL,
...
```{r, eval=FALSE}
    Unstained <- map(MyGatingSet[1], Utility_SingleColorQC, subsets = "lymphocytes",
        ...
        external = NULL,outpath = MainOutPath,
