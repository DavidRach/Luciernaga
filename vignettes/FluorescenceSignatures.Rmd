...
And as always, in combination with the `r CRANpkg("purrr")` map function, we can iterate over the entire GatingSet, returning isolated signatures for all single-color unmixing controls. 
