...
One advantage of retrieving the data from `LuciernagaQC()` ExportType = "fcs" outputs is that we can generate an additional type of plot to look at the individual brightness for the isolates signatures. This is accomplished through the `Luciernaga_Brightness()` function
