test_that("Utility_RidgePlots returns a ggplot2 object", {
  ...
  SinglePlot <- Utility_RidgePlots(gs=UnmixedGatingSet, subset="live",
                                   TheFill="Condition",TheX = "APC-Fire 810-A",
                                   TheY="name", returntype="plots",
                                   outpath=StorageLocation,
                                   filename="RidgePlot_Condition")

  # Did it return a patchwork object?
  expect_true(inherits(SinglePlot[[1]], "gg"))
})
