...
#' @param Display Default "selection" returns visual plots showing only
#'   TheN, alternatively "all" will show all signatures before filtering
#'   in the plots
#' @param AFOverlap Default NULL, alternately a file.path to an
#'   AFOverlap .csv file
#' @param nameOverride Default FALSE, if true uses all fcs files
#'   provided regardless if they match the experiment name string
#'   character provided in x
#' @param subsets Default lymphocytes, alternatively provide gate
#'   name for Luciernaga_QC to retrieve autofluorescence signatures from.
