...
FlowSightPageOne <- function(x) {
  ...
  if (length(DarkLine) == 1) {
    ...
    colnames(DarkLineThree) <- paste0("Dark Current ",
      colnames(DarkLineThree))
  ...
  PageOneData <- bind_cols(DateTime, FocusAdjust_DF, Autosampler_DF,
    Frame_DF, CoreStage_DF, SpatialLine_DF, DarkLine_DF,
    BrightfieldLineOne_DF, Calibration405_DF, Calibration488_DF,
    Calibration561_DF, Calibration642_DF, Calibration785_DF, Retro_DF)
